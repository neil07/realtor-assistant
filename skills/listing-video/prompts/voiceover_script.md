...
- `hook`: Hook text only — ≤ 10 words, first 3 seconds
- `walkthrough`: Walk-through narration — the main 20-second body
- `closer`: Closing CTA — last 5 seconds, must include agent name and phone
- `caption`: Instagram caption with 3-5 relevant hashtags (no "CAPTION:" prefix)
- `photo_sequence`: Array of photo index integers in suggested viewing order, e.g. `[1, 3, 5, 2, 7, 4, 8]`

Do NOT include section headers, labels, or any metadata outside the JSON object.
